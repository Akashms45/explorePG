  ...
  <div class="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="<?php echo "update_room.php?id=$id"?>"   class="active">
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Update Rooms</span>
      </div>
      ...
      <div class="overview-boxes">
        <div class="box">
          <div class="right-side">
            <a href="<?php echo "edit_room/single.php?id=$id"?>"><div class="box-topic">Update Single Sharing</div>
            <div class="number">
            <?php  
                        $count1="SELECT * FROM room_res WHERE code='$id' AND sharing='single'";
        ...
        <div class="box">
          <div class="right-side">
            <a href="<?php echo "edit_room/double.php?id=$id"?>"><div class="box-topic">Update Double Sharing</div>
            <div class="number">
            <?php  
        ...
        <div class="box">
          <div class="right-side">
            <a href="<?php echo "edit_room/triple.php?id=$id"?>"><div class="box-topic">Update Triple Sharing</div>
            <div class="number">
            <?php  
        ...
        <div class="box">
          <div class="right-side">
            <a href="<?php echo "edit_room/four.php?id=$id"?>"><div class="box-topic">Update Four Sharing</div>
            <div class="number">
            <?php  
